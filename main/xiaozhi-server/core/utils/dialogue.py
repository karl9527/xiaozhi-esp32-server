...
class Dialogue:
    ...
    def get_llm_dialogue_with_memory(
        ...
        if system_message:
            ...
            # 合并静态和动态为一条 system 消息
            # 某些 API/中转站不支持多条 system 消息，合并可避免报错
            combined_system = static_part
            ...
            if dynamic_part:
                ...
                combined_system += dynamic_part

            dialogue.append({"role": "system", "content": combined_system})
